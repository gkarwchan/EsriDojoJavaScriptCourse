define(["dojo/_base/declare", "esri/map", "esri/layers/FeatureLayer", "dojo/_base/Color", "dojo/_base/connect",
    "dojo/topic", "dojo/_base/lang"],
    function (declare, esriLib, featureLib, Color, connect, topic, lang) {
        return declare ( null, {
            mapDivName : null,
            mapLoadHandler: function () {
                topic.publish("map/loaded");
            },
            selectArea: function (args) {
                var query2 = new esri.tasks.Query();
                query2.text = args;
                this.featureLayer.selectFeatures(query2, esri.layers.FeatureLayer.SELECTION_NEW);
            },
            constructor: function (mapDiv, args) {
                topic.subscribe('dimension/changed', lang.hitch(this, this.resizeMap));

                topic.subscribe('map/select', lang.hitch(this, this.selectArea))
            ...
            initialize: function() {
                ...
                connect.connect(this.map, "onLoad", this.mapLoadHandler);
